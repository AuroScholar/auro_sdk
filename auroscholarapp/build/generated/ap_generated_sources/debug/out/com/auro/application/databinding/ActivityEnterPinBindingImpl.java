...
public class ActivityEnterPinBindingImpl extends ActivityEnterPinBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvEnterPinLogin, 7);
        sViewsWithIds.put(R.id.mobile_number_text, 8);
        sViewsWithIds.put(R.id.set_pin_text, 9);
        sViewsWithIds.put(R.id.pinView, 10);
        sViewsWithIds.put(R.id.bt_continue, 11);
        sViewsWithIds.put(R.id.forgotPassword, 12);
        sViewsWithIds.put(R.id.terms_condition, 13);
    }
    // views
    @NonNull
    ...
    public ActivityEnterPinBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }
    private ActivityEnterPinBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
