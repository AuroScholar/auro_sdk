...
public final class TeacherModule_ProvideCreateGroupViewModelFactoryFactory
  ...
  public TeacherModule_ProvideCreateGroupViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideCreateGroupViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideCreateGroupViewModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideCreateGroupViewModelFactory(
    ...
    return instance.provideCreateGroupViewModelFactory(
