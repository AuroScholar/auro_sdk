...
public final class TeacherModule_ProvideInformationDashboardDialogModelFactoryFactory
  ...
  public TeacherModule_ProvideInformationDashboardDialogModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideInformationDashboardDialogModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideInformationDashboardDialogModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideInformationDashboardDialogModelFactory(
    ...
    return instance.provideInformationDashboardDialogModelFactory(
