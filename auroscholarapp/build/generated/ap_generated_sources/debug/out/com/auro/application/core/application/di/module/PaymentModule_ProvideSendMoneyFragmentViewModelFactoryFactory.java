...
public final class PaymentModule_ProvideSendMoneyFragmentViewModelFactoryFactory
  ...
  public PaymentModule_ProvideSendMoneyFragmentViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideSendMoneyFragmentViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<PaymentUseCase> paymentUseCaseProvider,
      Provider<PaymentRemoteUseCase> paymentRemoteUseCaseProvider) {
    return new PaymentModule_ProvideSendMoneyFragmentViewModelFactoryFactory(
        module, paymentUseCaseProvider, paymentRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideSendMoneyFragmentViewModelFactory(
      PaymentModule instance,
      PaymentUseCase paymentUseCase,
      PaymentRemoteUseCase paymentRemoteUseCase) {
    return instance.provideSendMoneyFragmentViewModelFactory(paymentUseCase, paymentRemoteUseCase);
  }
}
