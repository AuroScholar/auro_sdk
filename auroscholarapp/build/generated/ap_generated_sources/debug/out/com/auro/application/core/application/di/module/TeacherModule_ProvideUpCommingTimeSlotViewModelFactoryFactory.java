...
public final class TeacherModule_ProvideUpCommingTimeSlotViewModelFactoryFactory
  ...
  public TeacherModule_ProvideUpCommingTimeSlotViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideUpCommingTimeSlotViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideUpCommingTimeSlotViewModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideUpCommingTimeSlotViewModelFactory(
    ...
    return instance.provideUpCommingTimeSlotViewModelFactory(
