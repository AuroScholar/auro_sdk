...
public class ActivityForgotPinBindingImpl extends ActivityForgotPinBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_we_have, 7);
        sViewsWithIds.put(R.id.mobile_number_text, 8);
        sViewsWithIds.put(R.id.set_pin_text, 9);
        sViewsWithIds.put(R.id.pin_view, 10);
        sViewsWithIds.put(R.id.confirm_pin_text, 11);
        sViewsWithIds.put(R.id.confirm_pin, 12);
        sViewsWithIds.put(R.id.bt_done_new, 13);
    ...
    public ActivityForgotPinBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private ActivityForgotPinBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (android.widget.ImageView) bindings[3]
            , (android.widget.ImageView) bindings[5]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[13]
            , (com.chaos.view.PinView) bindings[12]
            ...
            , (com.chaos.view.PinView) bindings[10]
