...
public final class HomeModule_ProvideTeacherDashboardViewModelFactoryFactory
  ...
  public HomeModule_ProvideTeacherDashboardViewModelFactoryFactory(
      HomeModule module,
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideTeacherDashboardViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<HomeDbUseCase> homeDbUseCaseProvider,
      Provider<HomeRemoteUseCase> homeRemoteUseCaseProvider) {
    return new HomeModule_ProvideTeacherDashboardViewModelFactoryFactory(
        module, homeUseCaseProvider, homeDbUseCaseProvider, homeRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideTeacherDashboardViewModelFactory(
      HomeModule instance,
      HomeUseCase homeUseCase,
      HomeDbUseCase homeDbUseCase,
      HomeRemoteUseCase homeRemoteUseCase) {
    return instance.provideTeacherDashboardViewModelFactory(
