...
public final class HomeModule_ProvideTransactionsFragmentViewModelFactoryFactory
  ...
  public HomeModule_ProvideTransactionsFragmentViewModelFactoryFactory(
      HomeModule module,
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideTransactionsFragmentViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<HomeDbUseCase> homeDbUseCaseProvider,
      Provider<HomeRemoteUseCase> homeRemoteUseCaseProvider) {
    return new HomeModule_ProvideTransactionsFragmentViewModelFactoryFactory(
        module, homeUseCaseProvider, homeDbUseCaseProvider, homeRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideTransactionsFragmentViewModelFactory(
      HomeModule instance,
      HomeUseCase homeUseCase,
      HomeDbUseCase homeDbUseCase,
      HomeRemoteUseCase homeRemoteUseCase) {
    return instance.provideTransactionsFragmentViewModelFactory(
