...
public final class HomeModule_ProvideStudentKycInfoViewModelFactoryFactory
  ...
  public HomeModule_ProvideStudentKycInfoViewModelFactoryFactory(
      HomeModule module,
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideStudentKycInfoViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<HomeDbUseCase> homeDbUseCaseProvider,
      Provider<HomeRemoteUseCase> homeRemoteUseCaseProvider) {
    return new HomeModule_ProvideStudentKycInfoViewModelFactoryFactory(
        module, homeUseCaseProvider, homeDbUseCaseProvider, homeRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideStudentKycInfoViewModelFactory(
      HomeModule instance,
      HomeUseCase homeUseCase,
      HomeDbUseCase homeDbUseCase,
      HomeRemoteUseCase homeRemoteUseCase) {
    return instance.provideStudentKycInfoViewModelFactory(
