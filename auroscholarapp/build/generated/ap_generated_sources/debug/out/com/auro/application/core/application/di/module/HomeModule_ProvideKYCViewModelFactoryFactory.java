...
public final class HomeModule_ProvideKYCViewModelFactoryFactory
  ...
  public HomeModule_ProvideKYCViewModelFactoryFactory(
      HomeModule module,
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideKYCViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<HomeDbUseCase> homeDbUseCaseProvider,
      Provider<HomeRemoteUseCase> homeRemoteUseCaseProvider) {
    return new HomeModule_ProvideKYCViewModelFactoryFactory(
        module, homeUseCaseProvider, homeDbUseCaseProvider, homeRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideKYCViewModelFactory(
      HomeModule instance,
      HomeUseCase homeUseCase,
      HomeDbUseCase homeDbUseCase,
      HomeRemoteUseCase homeRemoteUseCase) {
    return instance.provideKYCViewModelFactory(homeUseCase, homeDbUseCase, homeRemoteUseCase);
  }
}
