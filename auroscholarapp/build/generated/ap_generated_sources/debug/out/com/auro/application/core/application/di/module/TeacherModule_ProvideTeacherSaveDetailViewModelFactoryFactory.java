...
public final class TeacherModule_ProvideTeacherSaveDetailViewModelFactoryFactory
  ...
  public TeacherModule_ProvideTeacherSaveDetailViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideTeacherSaveDetailViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideTeacherSaveDetailViewModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideTeacherSaveDetailViewModelFactory(
    ...
    return instance.provideTeacherSaveDetailViewModelFactory(
