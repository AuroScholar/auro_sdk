...
public class ActivityDashboardBindingImpl extends ActivityDashboardBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"navigation_content_layout"},
            new int[] {1},
            new int[] {com.auro.application.R.layout.navigation_content_layout});
        sViewsWithIds = null;
    }
    // views
    // variables
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeNaviagtionContent((com.auro.application.databinding.NavigationContentLayoutBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeNaviagtionContent(com.auro.application.databinding.NavigationContentLayoutBinding NaviagtionContent, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
