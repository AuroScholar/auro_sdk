...
public class FragmentStudentUpdateProfileWithoutPinBindingImpl extends FragmentStudentUpdateProfileWithoutPinBinding  {
    ...
    static {
        sIncludes = new androidx.databinding.ViewDataBinding.IncludedLayouts(120);
        ...
        sViewsWithIds.put(R.id.tlschool, 73);
        sViewsWithIds.put(R.id.etschool, 74);
        sViewsWithIds.put(R.id.tlgrade, 75);
        sViewsWithIds.put(R.id.etgrade, 76);
        sViewsWithIds.put(R.id.llSppiner, 77);
        sViewsWithIds.put(R.id.tvGender, 78);
        sViewsWithIds.put(R.id.SpinnerGender, 79);
        sViewsWithIds.put(R.id.tlSchool, 80);
        sViewsWithIds.put(R.id.etSchoolname, 81);
        sViewsWithIds.put(R.id.tvSchoolType, 82);
        sViewsWithIds.put(R.id.SpinnerSchoolType, 83);
        sViewsWithIds.put(R.id.tvBoard, 84);
        sViewsWithIds.put(R.id.SpinnerBoard, 85);
        sViewsWithIds.put(R.id.tvLanguageMedium, 86);
        sViewsWithIds.put(R.id.SpinnerLanguageMedium, 87);
        sViewsWithIds.put(R.id.tvPrivateTution, 88);
        sViewsWithIds.put(R.id.spinnerPrivateTution, 89);
        sViewsWithIds.put(R.id.tvPrivateType, 90);
        sViewsWithIds.put(R.id.spinnerPrivateType, 91);
        sViewsWithIds.put(R.id.privateTypeArrow, 92);
        sViewsWithIds.put(R.id.state_title, 93);
        sViewsWithIds.put(R.id.state_spinner, 94);
        sViewsWithIds.put(R.id.privatestate, 95);
        sViewsWithIds.put(R.id.city_title, 96);
        sViewsWithIds.put(R.id.city_spinner, 97);
        sViewsWithIds.put(R.id.privatecity, 98);
        sViewsWithIds.put(R.id.yourSubjectsLayout, 99);
        sViewsWithIds.put(R.id.yourSubjects, 100);
        sViewsWithIds.put(R.id.edit_subject_icon, 101);
        sViewsWithIds.put(R.id.subjects_recyclerview, 102);
        sViewsWithIds.put(R.id.submitbutton, 103);
        sViewsWithIds.put(R.id.progressBar, 104);
        sViewsWithIds.put(R.id.auro_scholar_logo1, 105);
        sViewsWithIds.put(R.id.left_corner_image, 106);
        sViewsWithIds.put(R.id.back_button, 107);
        sViewsWithIds.put(R.id.title_first, 108);
        sViewsWithIds.put(R.id.tvEnterSetBelowNumnber, 109);
        sViewsWithIds.put(R.id.mobile_number_text, 110);
        sViewsWithIds.put(R.id.set_user_name, 111);
        sViewsWithIds.put(R.id.mobileLayout, 112);
        sViewsWithIds.put(R.id.etUsername, 113);
        sViewsWithIds.put(R.id.set_pin_text, 114);
        sViewsWithIds.put(R.id.pin_view, 115);
        sViewsWithIds.put(R.id.confirm_pin_text, 116);
        sViewsWithIds.put(R.id.confirm_pin, 117);
        sViewsWithIds.put(R.id.btdonenew, 118);
        sViewsWithIds.put(R.id.terms_condition, 119);
    }
    // views
    @NonNull
    ...
    public FragmentStudentUpdateProfileWithoutPinBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 120, sIncludes, sViewsWithIds));
    }
    private FragmentStudentUpdateProfileWithoutPinBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            ...
            , (androidx.appcompat.widget.AppCompatSpinner) bindings[85]
            , (androidx.appcompat.widget.AppCompatSpinner) bindings[79]
            ...
            , (android.widget.ImageView) bindings[107]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[118]
            , (android.widget.ImageView) bindings[30]
            , (androidx.appcompat.widget.AppCompatSpinner) bindings[97]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[96]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[34]
            , (com.chaos.view.PinView) bindings[117]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[116]
            ...
            , (android.widget.ImageView) bindings[101]
            ...
            , (android.widget.AutoCompleteTextView) bindings[81]
            , (android.widget.AutoCompleteTextView) bindings[60]
            , (android.widget.AutoCompleteTextView) bindings[58]
            , (com.auro.application.core.util.uiwidget.RPEditText) bindings[113]
            ...
            , (android.widget.ImageView) bindings[106]
            , (android.widget.LinearLayout) bindings[18]
            , (android.widget.LinearLayout) bindings[39]
            , (androidx.constraintlayout.widget.ConstraintLayout) bindings[77]
            , (android.widget.RelativeLayout) bindings[9]
            , (android.widget.LinearLayout) bindings[112]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[110]
            , (androidx.core.widget.NestedScrollView) bindings[21]
            , (com.chaos.view.PinView) bindings[115]
            , (android.widget.ImageView) bindings[92]
            , (android.widget.ImageView) bindings[98]
            , (android.widget.ImageView) bindings[95]
            , (androidx.constraintlayout.widget.ConstraintLayout) bindings[22]
            , (android.widget.ImageView) bindings[23]
            , (android.widget.ProgressBar) bindings[104]
            ...
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[111]
            ...
            , (androidx.appcompat.widget.AppCompatSpinner) bindings[94]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[93]
            , (androidx.recyclerview.widget.RecyclerView) bindings[102]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[103]
            , (android.widget.ImageView) bindings[12]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[119]
            ...
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[108]
            , (com.google.android.material.textfield.TextInputLayout) bindings[80]
            ...
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[84]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[109]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[78]
            ...
            , (android.widget.LinearLayout) bindings[99]
            );
