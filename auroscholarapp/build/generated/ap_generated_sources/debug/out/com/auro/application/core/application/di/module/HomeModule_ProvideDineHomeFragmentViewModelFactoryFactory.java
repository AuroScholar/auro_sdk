...
public final class HomeModule_ProvideDineHomeFragmentViewModelFactoryFactory
  ...
  public HomeModule_ProvideDineHomeFragmentViewModelFactoryFactory(
      HomeModule module,
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideDineHomeFragmentViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<HomeDbUseCase> homeDbUseCaseProvider,
      Provider<HomeRemoteUseCase> homeRemoteUseCaseProvider) {
    return new HomeModule_ProvideDineHomeFragmentViewModelFactoryFactory(
        module, homeUseCaseProvider, homeDbUseCaseProvider, homeRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideDineHomeFragmentViewModelFactory(
      HomeModule instance,
      HomeUseCase homeUseCase,
      HomeDbUseCase homeDbUseCase,
      HomeRemoteUseCase homeRemoteUseCase) {
    return instance.provideDineHomeFragmentViewModelFactory(
