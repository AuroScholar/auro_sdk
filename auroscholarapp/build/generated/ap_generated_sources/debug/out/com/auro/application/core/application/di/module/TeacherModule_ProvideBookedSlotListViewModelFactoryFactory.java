...
public final class TeacherModule_ProvideBookedSlotListViewModelFactoryFactory
  ...
  public TeacherModule_ProvideBookedSlotListViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideBookedSlotListViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideBookedSlotListViewModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideBookedSlotListViewModelFactory(
    ...
    return instance.provideBookedSlotListViewModelFactory(
