...
public class FragmentUpCommingBookBindingImpl extends FragmentUpCommingBookBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.booked_tab, 3);
        sViewsWithIds.put(R.id.rvChooseSlot, 4);
    }
    // views
    @NonNull
    ...
    public FragmentUpCommingBookBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentUpCommingBookBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
