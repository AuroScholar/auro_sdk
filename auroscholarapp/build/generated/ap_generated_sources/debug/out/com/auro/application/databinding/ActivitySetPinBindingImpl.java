...
public class ActivitySetPinBindingImpl extends ActivitySetPinBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvEnterSetBelowNumnber, 7);
        sViewsWithIds.put(R.id.mobile_number_text, 8);
        sViewsWithIds.put(R.id.set_user_name, 9);
        sViewsWithIds.put(R.id.mobileLayout, 10);
        sViewsWithIds.put(R.id.etUsername, 11);
        sViewsWithIds.put(R.id.set_pin_text, 12);
        sViewsWithIds.put(R.id.pin_view, 13);
        sViewsWithIds.put(R.id.confirm_pin_text, 14);
        sViewsWithIds.put(R.id.confirm_pin, 15);
        sViewsWithIds.put(R.id.bt_done_new, 16);
        sViewsWithIds.put(R.id.terms_condition, 17);
    }
    // views
    @NonNull
    ...
    public ActivitySetPinBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 18, sIncludes, sViewsWithIds));
    }
    private ActivitySetPinBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (android.widget.ImageView) bindings[3]
            , (android.widget.ImageView) bindings[5]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[16]
            , (com.chaos.view.PinView) bindings[15]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[14]
            , (com.auro.application.core.util.uiwidget.RPEditText) bindings[11]
            , (android.widget.ImageView) bindings[4]
            , (android.widget.LinearLayout) bindings[10]
            , (com.auro.application.core.util.uiwidget.RPTextView) bindings[8]
            , (com.chaos.view.PinView) bindings[13]
