...
public final class TeacherModule_ProvideTeacherModelFactoryFactory
  ...
  public TeacherModule_ProvideTeacherModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideTeacherModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideTeacherModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideTeacherModelFactory(
    ...
    return instance.provideTeacherModelFactory(
