...
public final class TeacherModule_ProvideHomeActivityModelFactoryFactory
  ...
  public TeacherModule_ProvideHomeActivityModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideHomeActivityModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideHomeActivityModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideHomeActivityModelFactory(
    ...
    return instance.provideHomeActivityModelFactory(
