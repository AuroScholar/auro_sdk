...
public final class TeacherModule_ProvideTeacherProfileViewModelFactoryFactory
  ...
  public TeacherModule_ProvideTeacherProfileViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideTeacherProfileViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideTeacherProfileViewModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideTeacherProfileViewModelFactory(
    ...
    return instance.provideTeacherProfileViewModelFactory(
