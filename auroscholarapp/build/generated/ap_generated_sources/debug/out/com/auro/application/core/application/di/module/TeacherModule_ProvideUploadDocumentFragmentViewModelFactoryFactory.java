...
public final class TeacherModule_ProvideUploadDocumentFragmentViewModelFactoryFactory
  ...
  public TeacherModule_ProvideUploadDocumentFragmentViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideUploadDocumentFragmentViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideUploadDocumentFragmentViewModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideUploadDocumentFragmentViewModelFactory(
    ...
    return instance.provideUploadDocumentFragmentViewModelFactory(
