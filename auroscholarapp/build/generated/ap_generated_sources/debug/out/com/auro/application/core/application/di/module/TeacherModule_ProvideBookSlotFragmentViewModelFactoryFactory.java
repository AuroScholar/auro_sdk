...
public final class TeacherModule_ProvideBookSlotFragmentViewModelFactoryFactory
  ...
  public TeacherModule_ProvideBookSlotFragmentViewModelFactoryFactory(
  ...
  public ViewModelFactory get() {
    return Preconditions.checkNotNull(
        module.provideBookSlotFragmentViewModelFactory(
  ...
  public static Factory<ViewModelFactory> create(
      ...
      Provider<TeacherDbUseCase> teacherDbUseCaseProvider,
      Provider<TeacherRemoteUseCase> teacherRemoteUseCaseProvider) {
    return new TeacherModule_ProvideBookSlotFragmentViewModelFactoryFactory(
        module, teacherUseCaseProvider, teacherDbUseCaseProvider, teacherRemoteUseCaseProvider);
  }

  public static ViewModelFactory proxyProvideBookSlotFragmentViewModelFactory(
    ...
    return instance.provideBookSlotFragmentViewModelFactory(
