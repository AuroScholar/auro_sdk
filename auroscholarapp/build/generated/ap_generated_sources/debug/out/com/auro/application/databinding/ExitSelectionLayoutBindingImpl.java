...
public class ExitSelectionLayoutBindingImpl extends ExitSelectionLayoutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.hindi_layout, 7);
        sViewsWithIds.put(R.id.txthindi, 8);
        sViewsWithIds.put(R.id.english_layout, 9);
        sViewsWithIds.put(R.id.txtenglish, 10);
        sViewsWithIds.put(R.id.btn_yes, 11);
    ...
    public ExitSelectionLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private ExitSelectionLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
